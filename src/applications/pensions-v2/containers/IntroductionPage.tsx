        ...
        <ol>
          <li className="process-step list-one">
            ...
            <div>
              ...
              possible date that you can start getting benefits, you’ll need to
              complete an Intent to File a Claim for Compensation and/or
              Pension, or Survivors Pension, and/or DIC (VA Form 21-0966).
              Starting your pension application doesn’t show your intent to
              file.
            </div>
            <div>
            ...
            <div>
              <strong>Note:</strong> Your date of claim is the date that we
          ...
          <li className="process-step list-two">
            ...
            <div className="usa-alert usa-alert-info">
              <div className="usa-alert-body">
                ...
                <div className="usa-alert-text">
                  <p>
                    The Fully Developed Claim (FDC) program is the fastest way
                    to get your claim processed, and there's no risk for you to
                    participate. With this program, you send in all the
                    evidence, or supporting documents, you have when you file
                    your claim. We can make a decision on your application
            ...
            <p>
              <strong>
                You might qualify for Aid and Attendance and Housebound benefits
              </strong>
            </p>
            <a href="/pension/aid-attendance-housebound/" target="_blank">
              Learn more about Aid and Attendance and Housebound Benefits
            </a>
            .<br />
            <br />
            <p>
